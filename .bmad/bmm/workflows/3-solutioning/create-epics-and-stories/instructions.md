...
Architecture says: "Use PostgreSQL with sha256_crypt hashing, JWT tokens, rate limiting"
...
And the user record is created in users table with sha256_crypt hash (Architecture 6.2)
