      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-6 py-4">
          ...
          <section>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <span className="font-semibold text-red-700 mr-2 min-w-[60px]">第 9 类</span>
                <span className="text-sm">最强，价格在所有均线上方</span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold text-red-500 mr-2 min-w-[60px]">第 8 类</span>
                <span className="text-sm">攻克 240 日线</span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold text-orange-500 mr-2 min-w-[60px]">第 7 类</span>
                <span className="text-sm">攻克 120 日线</span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold text-amber-500 mr-2 min-w-[60px]">第 6 类</span>
              ...
              <li className="flex items-start">
                <span className="font-semibold text-lime-500 mr-2 min-w-[60px]">第 4 类</span>
                <span className="text-sm">攻克 30 日线</span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold text-green-500 mr-2 min-w-[60px]">第 3 类</span>
                <span className="text-sm">攻克 20 日线</span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold text-emerald-500 mr-2 min-w-[60px]">第 2 类</span>
                <span className="text-sm">攻克 10 日线</span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold text-emerald-700 mr-2 min-w-[60px]">第 1 类</span>
          ...
          <section>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <span className="font-semibold text-rise mr-2 min-w-[60px]">反弹</span>
                <span className="text-sm">当前价格高于 5 天前价格</span>
              </li>
              <li className="flex items-start">
                <span className="font-semibold text-fall mr-2 min-w-[60px]">调整</span>
